...
import { sendAppointmentNotifications } from "@/utils/sendAppointmentNotifications";
...
export async function POST(req) {
    ...
    try {
        ...
        await sendAppointmentNotifications("dixantashrestha08@gmail.com", "Your appointment has been successfully booked!");
        return NextResponse.json(newAppointment, { status: 201 });
    } catch (error) {
        console.error("Error creating appointment:", error);
        return NextResponse.json(
